...
class RegisterPageState extends State<RegisterPage>{
  ...
  void setData(String email, String nama) async {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Silahkan Login dengan email terdaftar atau buat akun baru.", style: TextStyle(color: Colors.black.withOpacity(0.5),fontWeight: FontWeight.normal),textAlign: TextAlign.center,),
